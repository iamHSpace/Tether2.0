          ...
          {pageLoading ? (
            ...
            <div className="bg-white rounded-2xl p-12 border border-dashed border-gray-200 text-center">
              ...
              <p className="text-xs text-gray-400 max-w-xs mx-auto">
                {search ? "Try a different name." : "Browse creators in Discover and click Save to add them here."}
              </p>
              {!search && (
                <a href="/discover" className="inline-block mt-4 text-brand-600 text-sm font-medium hover:text-brand-700">
                  Go to Discover →
                </a>
              )}
            </div>
